...
const text = `Save VEHICLE Schedule`
const log = require('../log/winston').logger(text);



module.exports.saveVehicleScheduleStart = function () {

    for (let cron of conf.scheduleCron.SAVE_VEHICLE) {
        ...
        schedule.scheduleJob(text, cron, async () => {
            ...
            const childProcess = fork('./childProcess/saveVehicle.js')
